import 'package:api_dio/controller/diocontrl.dart';
import 'package:api_dio/utils/cons_snackbar.dart';
import 'package:api_dio/utils/consant.dart';
      ...
      body: Obx(() =>
          SizedBox(
            ...
            child: controller.isNetConnected.value
                ...
                ? Center(child: Lottie.asset("assets/animation/Animation - 1709277061833.json")) : getData()
                : noInternet(context),
          )),
    );
  }
